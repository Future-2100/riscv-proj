...
#endif
                    VL_FATAL_MT("/home/wuchenze/riscv-proj/single_cycle/vsrc/top.v", 3, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/wuchenze/riscv-proj/single_cycle/vsrc/top.v", 3, "", "NBA region did not converge.");
            }
...
void Vtop___024root___timing_commit(Vtop___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->__VactTriggered.at(2U))))) {
        vlSelf->__VtrigSched_hb25cf626__0.commit("@(negedge top.clk)");
    }
}
...
void Vtop___024root___timing_resume(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(2U)) {
        vlSelf->__VtrigSched_hb25cf626__0.resume("@(negedge top.clk)");
    }
}
