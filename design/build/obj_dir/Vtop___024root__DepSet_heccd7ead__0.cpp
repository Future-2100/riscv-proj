...
#endif
                    VL_FATAL_MT("/home/wuchenze/riscv-proj/design/vsrc/top.v", 3, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/wuchenze/riscv-proj/design/vsrc/top.v", 3, "", "NBA region did not converge.");
            }
...
void Vtop___024root___timing_commit(Vtop___024root* vlSelf) {
    ...
    // Body
    if ((! (4ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_hb25c05b7__0.commit("@(negedge top.clk)");
    }
}
...
void Vtop___024root___timing_resume(Vtop___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_hb25c05b7__0.resume("@(negedge top.clk)");
    }
}
